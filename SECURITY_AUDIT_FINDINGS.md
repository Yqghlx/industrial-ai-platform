...
**影响文件**:
- `.env` - 包含明文密码 `POSTGRES_PASSWORD=kP121e8pXgy7rQX1MVgdpjrmoOxq8rKu`
...
**证据**:
```
JWT_SECRET=6j6A+0h0dPS2akVluE9Uo5WKT71Bovp1J65q/UxL5pY=
ENCRYPTION_KEY=jnF7u3sVOjF7ixx7gzB3jQJJd+WktZkCWHjIVEei7Ro=
REDIS_PASSWORD=zF+zokWFpFY3uCvOrZ40G0ttMfdhzIyj
DB_PASSWORD=JeVA4cZSSI5xQ2XXI7FWXJsoa5YkW26d
ADMIN_PASSWORD=IndAI_nrobZbWY0RRmtYV4CYXP_2026
```
