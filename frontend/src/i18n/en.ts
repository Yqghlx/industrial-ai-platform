export default {
  ...
  system: {
    ...
    confirmDeleteModel: 'Are you sure you want to delete this model? Active models cannot be deleted.',
    cannotDeleteActive: 'Cannot delete the active model, please switch to another first',
    modelActivated: 'Model activated',
    modelCreated: 'Model configuration created',
